...
const Home = () => {
  ...
  <MainHeader/>
      <div>
                ...
                <div class="row aic">
                  ...
                  <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="rectangle-right">
                      ...
                      <ul class="list">
                        <li>Download Superking App</li>
                        <li>Recharge Your Wallet</li>
                        <li>Play Satta Betting</li>
                        <li>Win Huge Real Cash</li>
                      </ul>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-5 d-none d-lg-block">
                  ...
                  <img src="assets/betimg/sattaphn.png" />
                </div>
          ...
          <div class="footer-area pd-80">
            ...
            <div class="footer-bg">
              ...
              <div class="footer-disclaimer">
                <div class="copyright">
                  <div class="container">
                    <div class="row">
                      <div class="col-md-12">
                        <p class="social">
                          <a href="https://twitter.com/Superkingapp2" class="mdi mdi-twitter" title="sattabet twitter" rel="nofollow" target="_blank"></a>
                          <a href="https://www.facebook.com/playonlinedesawer/" class="mdi mdi-facebook" title="sattabet facebook" rel="nofollow" target="_blank"></a>
                          <a href="https://www.youtube.com/channel/UCIg_w2Nx-26HBVRaa4sVBRg" class="mdi mdi-youtube" title="sattabet youtube" rel="nofollow" target="_blank"></a>
                          <a href="https://www.instagram.com/matkakingplay/" class="mdi mdi-instagram" title="Matka king instagram"></a>
                        </p>
                      </div>
                ...
                <div class="footer-martket-link">
                  <ul>
                    <li>
                      <a href="home.aspx">MatkaKing Satta  |</a>
                    </li>
                    <li>
                      <a href="home.aspx">Disawar Matka |</a>
                    </li>
                    <li>
                      <a href="home.aspx">Gali Satta |</a>
                    </li>
                    <li>
                      <a href="home.aspx">Ghaziabad Matka  |</a>
                    </li>
                    <li>
                      <a href="home.aspx">Faridabad Satta  |</a>
                    </li>
                    <li>
                      <a href="home.aspx">Kota Express Satta  |</a>
                    </li>
                    <li>
                      <a href="home.aspx">Satta Matka Result</a>
                    </li>
                  </ul>
                </div>
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <p>© 2020 Matka king. All Rights Reserved.</p>
                        </div>
                        <div class="col-lg-6 text-lg-right">
                          <div class="Privacy-link-black">
                            <p class="text-black-call">

                              <a href="tel:+917737788753" class="number">WHATSAPP CALL : +919779540229</a></p>
                          </div>
        ...
        <div id="topcontrol" title="Scroll to Top" style={{position: "fixed", bottom: "5px", right: "5px",opacity: 0, cursor: "pointer"}}><i class="far fa-long-arrow-alt-up"></i></div>
    </>
  );
};
export default Home;